    ...
    <div id="lightbox" class="fixed inset-0 bg-black/80 hidden items-center justify-center z-50 cursor-pointer">
        ...
        const projectData = {
            project1: {
                ...
                image: "<?php echo e(asset('img/projects/prediksi-ginjal/Screenshot-1.png')); ?>", // ← Pakai asset()
                ...
                // demo: "#",
                screenshots: [
                    "<?php echo e(asset('img/projects/prediksi-ginjal/Screenshot-2.png')); ?>", // ← asset(),
                    "<?php echo e(asset('img/projects/prediksi-ginjal/Screenshot-3.png')); ?>", // ← asset(),
                    "<?php echo e(asset('img/projects/prediksi-ginjal/Screenshot-4.png')); ?>" // ← asset(),
                ]
            },
            project2: {
                title: "Aplikasi berbasis PWA Point Of Sale",
                category: "Aplikasi Web",
                image: "<?php echo e(asset('img/projects/PointOfSale/Picture-1.png')); ?>", // ← asset(),
                ...
                // demo: "#",
                screenshots: [
                    "<?php echo e(asset('img/projects/PointOfSale/Picture-2.png')); ?>", // ← asset(),
                    "<?php echo e(asset('img/projects/PointOfSale/Picture-3.png')); ?>", // ← asset(),
                    "<?php echo e(asset('img/projects/PointOfSale/Picture-4.png')); ?>" // ← asset(),
                ]
            },
            project3: {
                title: "Integrasi Fingerprint ke dalam website Warung Tekan (WARTEK)",
                category: "Aplikasi Web",
                image: "<?php echo e(asset('img/projects/fingerprint/fingerprint-1.png')); ?>", // ← asset(),
                ...
                // demo: "#",
                screenshots: [
                    "<?php echo e(asset('img/projects/fingerprint/fingerprint-2.png')); ?>", // ← asset(),
                    "<?php echo e(asset('img/projects/fingerprint/fingerprint-3.png')); ?>", // ← asset(),
                    "<?php echo e(asset('img/projects/fingerprint/fingerprint-4.png')); ?>" // ← asset(),
                ]
            },
            project4: {
                title: "Aplikasi Mobile Toko Gitar",
                category: "Aplikasi Mobile",
                image: "<?php echo e(asset('video/Flutter.mp4')); ?>",
        ...
        <div class="container mx-auto px-6">
            ...
            <div class="grid md:grid-cols-2 gap-12 max-w-6xl mx-auto">
                ...
                <div data-aos="fade-left">
                    <form action="<?php echo e(route('contact.send')); ?>" method="POST" class="card p-8">
                        <?php echo csrf_field(); ?>
                        <div class="mb-6">
...
<?php /**PATH C:\Users\user\Downloads\personal-website\resources\views/welcome.blade.php ENDPATH**/ ?>